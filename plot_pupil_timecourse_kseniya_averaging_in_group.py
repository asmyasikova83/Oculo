...
#p333 <- p3334
#P060 <- P061
#subj_list = ['P001', 'P004', 'P019', 'P022', 'P032', 'P039', 'P040', 'P047', 'P053', 'P055', 'P059', 'P061', 'P063', 'P064', 'P065',
#      'P301', 'P304', 'P307', 'P313', 'P314', 'P321', 'P322', 'P324', 'P326', 'P327', 'P329', 'P334', 'P335', 'P338', 'P341']
...
plot_stat_comparison(group=group, comp1=risk_NT_mean, comp2=norisk_NT_mean, comp1_stderr=risk_NT_stderr, comp2_stderr=norisk_NT_stderr, p_val=p_val, p_fdr=p_fdr,p_mul=p_mul, time=time, title=f'{comp1_label} vs {comp2_label}, {N} subjects',  folder='comparison',
