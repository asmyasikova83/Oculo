...
Tuk <- emmeans(m2, pairwise ~ feedback_prev|train|group  , adjust = 'tukey',lmer.df = "satterthwaite",lmerTest.limit=8000,level = 0.99)
...
output_p1         
pic_1 <- ggplot(output_p1, aes(x=group, y=emmean, ymin=emmean-SE, ymax = emmean+SE, fill = feedback_prev))+
  geom_col(position = "dodge",colour =  c('black')) +
  geom_hline(yintercept= 0.0, linetype='dashed', col = 'black', size = 1.5)+ylim(-0.5, 0.5)+
  theme_classic((size = 20))+ scale_x_discrete(labels=c('NT'))+
  ...
  scale_fill_discrete(name="Previous\nFeedback",
                      labels=c("Loss", "Gain"))
pic_1
pic1_signif <- pic_1+  geom_signif(y_position=c(y_values_p1$y_max+0.32),
                                   xmin=c(y_values_p1$number-0.5), xmax=c(y_values_p1$number+0.5),
...
signif_p2
pic_2 <- ggplot(output_p2, aes(x=group, y=emmean, ymin=emmean-SE, ymax = emmean+SE, fill = feedback_prev))+
  geom_col(position = "dodge",colour =  c('black')) +
  geom_hline(yintercept= 0.0, linetype='dashed', col = 'black', size = 1.5)+ylim(-0.5, 0.5)+
  theme_classic((size = 20))+ scale_x_discrete(labels=c("NT"))+
  geom_point(position=position_dodge(0.09)) + geom_errorbar(width = 0.2,  position=position_dodge(0.9), size=0.6)+
  labs(x = '', y = "Rel.pupil area 1000-2200 ms",col="black")+
  ggtitle("After learning") +
  scale_fill_discrete(name="Previous\nFeedback",
                      labels=c("Loss", "Gain"))
pic_2
pic2_signif <- pic_2+  geom_signif(y_position=c(y_values_p2$y_max+0.32),
                                   xmin=c(y_values_p2$number-1.5), xmax=c(y_values_p2$number-0.5),
...
pic_4 <- ggplot(output_p4, aes(x=group, y=emmean, ymin=emmean-SE, ymax = emmean+SE, fill = feedback_prev))+
  geom_col(position = "dodge",colour =  c('black')) +
  geom_hline(yintercept= 0.0, linetype='dashed', col = 'black', size = 1.5)+ylim(-0.5, 0.5)+
  theme_classic((size = 20))+ scale_x_discrete(labels=c("ASD"))+
  geom_point(position=position_dodge(0.09)) + geom_errorbar(width = 0.2,  position=position_dodge(0.9), size=0.6)+
  labs(x = '', y = "Rel.pupil area 1000-2200 ms",col="black")+
  ggtitle("No learning") +
  scale_fill_discrete(name="Previous\nFeedback",
...
pic4_signif <- pic_4 + geom_signif(y_position=c(y_values_p4$y_max+0.32),
...
signif_p3 
pic_3 <- ggplot(output_p3, aes(x=group, y=emmean, ymin=emmean-SE, ymax = emmean+SE, fill = feedback_prev))+
  geom_col(position = "dodge",colour =  c('black')) +
  geom_hline(yintercept= 0.0, linetype='dashed', col = 'black', size = 1.5)+ylim(-0.5, 0.5)+
  theme_classic((size = 20))+ scale_x_discrete(labels=c("ASD"))+
  geom_point(position=position_dodge(0.09)) + geom_errorbar(width = 0.2,  position=position_dodge(0.9), size=0.6)+
  ...
  scale_fill_discrete(name="Previous\nFeedback",
                      labels=c("Loss", "Gain"))
y_values_p3$number
pic3_signif <- pic_3 + geom_signif(y_position=c(y_values_p3$y_max+0.32),
                                   xmin=c(y_values_p3$number-1.5), xmax=c(y_values_p3$number-0.5),
...
ggsave('C:/Users/trosh/OneDrive/jobs_Miasnikova/Oculo/pics_articles/article_at_nt/Pupil_feedback_prev_AT.png',pn_at,width =  12, height = 6)

ggsave('C:/Users/trosh/OneDrive/jobs_Miasnikova/Oculo/pics_articles/article_at_nt/Pupil_feedback_prev_NT.png',pn_nt,width =  12, height = 6)
