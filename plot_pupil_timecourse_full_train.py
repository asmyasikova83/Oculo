...
def plot_stat_comparison(group, comp1, comp2, comp1_stderr, comp2_stderr, p_val, p_fdr, p_mul, res_tfce, time, title, folder,
...
for j,subj in enumerate(subj_list):
    ...
    for run in runs:
        ...
        df_trained= df_choice[df_choice['train'] == comp1]
        df_block1 = df_trained[df_trained['block'] == run]
        df_not_trained = df_choice[df_choice['train'] == comp2]
...
plot_stat_comparison(group=group, comp1=norisk_NT_mean, comp2=risk_NT_mean, comp1_stderr=norisk_NT_stderr, comp2_stderr=risk_NT_stderr, p_val=p_val, p_fdr=p_fdr,p_mul=p_mul, res_tfce=res_tfce, time=time, title=f'{comp1_label} vs {comp2_label} {group}',  folder='comparison',
