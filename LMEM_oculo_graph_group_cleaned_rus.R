...
output2 <-output2[group == 'autists']
y_values <- y_values[group == 'autists']
Tuk_stat <- Tuk_stat[group == 'autists']
df_large_group <- df_large_group[group == 'autists']
